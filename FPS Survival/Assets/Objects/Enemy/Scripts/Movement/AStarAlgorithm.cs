...
public class AStarAlgorithm: MonoBehaviour
{
    ...
    public List<Vector3Int> AStarPathfinding(Vector3 startPosition, Vector3 goalPosition)
    {
        return AStarPathfinding(new Vector3Int(
            Mathf.RoundToInt(startPosition.x),
            Mathf.RoundToInt(startPosition.y),
            Mathf.RoundToInt(startPosition.z)
            ), new Vector3Int(
            Mathf.RoundToInt(goalPosition.x),
            Mathf.RoundToInt(goalPosition.y),
            Mathf.RoundToInt(goalPosition.z)));
    }
